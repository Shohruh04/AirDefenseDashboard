    ...
    <div className="w-full h-full p-6 overflow-y-auto">
      <div className="max-w-7xl mx-auto">
        ...
        <Card className="mb-6">
          ...
          <CardContent>
            <div className="flex flex-wrap gap-4">
              ...
              <Select value={filterType} onValueChange={(value) => setFilterType(value as Alert['type'] | 'ALL')}>
              ...
              <Select value={filterPriority} onValueChange={(value) => setFilterPriority(value as Alert['priority'] | 'ALL')}>
                <SelectTrigger className="w-40">
        ...
        <Card>
          <CardHeader>
            <CardTitle>
              Alert Log ({filteredAlerts.length} {filteredAlerts.length === 1 ? 'alert' : 'alerts'})
            </CardTitle>
          </CardHeader>
          <CardContent>
                  ...
                  >
                    <div className="flex-shrink-0 mt-1">
                      <div className={`p-1.5 rounded-full ${
                        alert.type === 'THREAT' ? 'bg-red-100 text-red-600' :
                        alert.type === 'DETECTION' ? 'bg-blue-100 text-blue-600' :
                        alert.type === 'SYSTEM' ? 'bg-yellow-100 text-yellow-600' :
            ...
            <div className="flex items-start gap-3 p-3 bg-blue-50 dark:bg-blue-950 rounded-md">
              ...
              <div className="text-sm">
                ...
                <p className="text-blue-700 dark:text-blue-300">
                  All alerts and events displayed are simulated and generated for educational purposes only. 
                  This system does not monitor real aircraft or security threats.
                </p>
              </div>
            </div>
          </CardContent>
