        ...
        <div className="mb-6 flex justify-between items-start">
          <div>
            <h2 className="text-2xl font-bold text-foreground mb-2">
              AI Alerts & Events Log
            </h2>
            <p className="text-muted-foreground">
              AI-generated monitoring of system events and security alerts
            </p>
          </div>
            ...
            <div className="flex items-start gap-3 p-3 bg-blue-50 dark:bg-blue-950 rounded-md">
              ...
              <div className="text-sm">
                ...
                <p className="text-blue-700 dark:text-blue-300">
                  All alerts are generated by the AI classification engine
                  based on simulated aircraft data. This system does not monitor
                  real aircraft or security threats. AI-tagged alerts indicate
                  outputs from the threat assessment algorithm.
                </p>
              </div>
            </div>
          </CardContent>
