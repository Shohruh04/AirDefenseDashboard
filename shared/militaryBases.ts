...
export interface MilitaryBase {
  ...
  lat: number;
  lon: number;
  type: string; // operator: china, france, india, japan, italy, russia, uae, uk, us-nato
  country: string;
  arm: string;
  status: 'active' | 'planned' | 'controversial';
  description: string;
}

// Operator colors for map markers
export const OPERATOR_COLORS: Record<string, { color: string; label: string }> = {
  'us-nato': { color: '#3b82f6', label: 'US/NATO' },
  'russia':  { color: '#ef4444', label: 'Russia' },
  'china':   { color: '#eab308', label: 'China' },
  'uk':      { color: '#06b6d4', label: 'UK' },
  'france':  { color: '#e2e8f0', label: 'France' },
  'india':   { color: '#f97316', label: 'India' },
  'italy':   { color: '#22c55e', label: 'Italy' },
  'uae':     { color: '#a855f7', label: 'UAE' },
  'japan':   { color: '#ec4899', label: 'Japan' },
};
